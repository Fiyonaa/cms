...
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="<?= site_url('assets')?>/assets/" data-template="vertical-menu-template-free">
  <head>
    <meta charset="utf-8" />
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?= base_url('assets/front/')?>assets/img/mixue-logo.png" />
