...
<html
  ...
  data-assets-path="<?= site_url('assets')?>../assets/"
...
>
  <head>
    ...
    <link rel="stylesheet" href="<?= site_url('assets')?>../assets/vendor/libs/apex-charts/apex-charts.css" />
  ...
  <body>
            ...
            <?php if($this->session->userdata('level')=='admin') { ?>
              ...
              <li class="menu-item <?php if($menu=='saran'){ echo "active"; }?>">
                <a href="<?= site_url('admin/saran')?>" class="menu-link">
                  ...
                  <div data-i18n="Tables">Saran</div>
                </a>
              </li>
              <!-- Misc -->
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="<?= site_url('assets')?>../assets/img/avatars/1.png" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , made with ❤️ by
                  <a href="https://themeselection.com" target="_blank" class="footer-link fw-bolder">piiyonaa</a>
                </div>
    ...
    <!-- Vendors JS -->
    <script src="<?= site_url('assets')?>../assets/vendor/libs/apex-charts/apexcharts.js"></script>

    <!-- Main JS -->
    <script src="<?= site_url('assets')?>../assets/js/main.js"></script>

    <!-- Page JS -->
    <script src="<?= site_url('assets')?>../assets/js/dashboards-analytics.js"></script>
